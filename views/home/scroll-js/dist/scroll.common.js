...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('core-js/modules/es.array.concat'), require('core-js/modules/es.array.join'), require('core-js/modules/es.object.keys'), require('core-js/modules/es.object.to-string'), require('core-js/modules/es.promise')) :
	typeof define === 'function' && define.amd ? define(['exports', 'core-js/modules/es.array.concat', 'core-js/modules/es.array.join', 'core-js/modules/es.object.keys', 'core-js/modules/es.object.to-string', 'core-js/modules/es.promise'], factory) :
	...
	function _scrollTo() {
	  _scrollTo = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(el) {
	    var options,
	        scroll,
